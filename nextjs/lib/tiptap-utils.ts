...
export const handleImageUpload = async (
  ...
  const presignRes = await fetch("/api/upload/newsletter-image-presign", {
    method: "POST",
  ...
  await fetch(url, { method: "PUT", body: file, headers: { "Content-Type": file.type }, signal: abortSignal })
